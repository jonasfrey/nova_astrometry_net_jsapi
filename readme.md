<!-- {"s_msg":"this file was automatically generated","s_by":"f_generate_markdown.module.js","s_ts_created":"Mon Mar 04 2024 10:50:53 GMT+0100 (Central European Standard Time)","n_ts_created":1709545853800} -->
...
```
## f_v_o_job_info__from_s_filename_original
this will search throu all job id's until a job with the filename is found
if no job is found, null is returned
important!: this can take a long time
```javascript
